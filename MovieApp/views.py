...
def add_form(request):
    if request.method == "POST":
        addmovie = AddMovie(request.POST, request.FILES)
    ...
    return render(
        request, "movies.html", {"AddMovie": AddMovie, "all_movies": all_movies}
    )
...
def edit_profile(req):
    ...
    return render(
        ...
        "warning.html",
        {
            "message": f"Necesitas estar logeado para realizar esta accion",
            "my_form": my_form,
        },
    )
